...
```{r speiClassification, echo=FALSE, tab.cap="Classification of Droughts Based on the SPEI ((ref:mckee1993))."}
spei_classification <- data.frame(
  SPEI = c("0 to -0.99", "-1 to -1.49", "-1.5 to -1.99", "less than or equal to -2"),
