...
To implement the SPEI, we utilized the freely accessible SPEI package (@spei2024). This process requires the water balance, for the calculation of which the potential evapotranspiration must first be determined.
