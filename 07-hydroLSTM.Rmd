...
```{r lstm, cache=FALSE, out.width="70%", fig.cap = 'visualization of a LSTM cell at time step t (image adapted from @lstmimage)',fig.align="center", echo=FALSE, eval = TRUE}
