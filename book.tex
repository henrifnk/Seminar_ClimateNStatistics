...
Also for asymmetry measures defined by equation \eqref{eq:asymmeassupgen}, an upper bound exists for every copula \(C\) (see \citet{durante2010a}). Specifically, it holds that
...
{\centering \includegraphics[width=0.7\linewidth]{./work/04-archimax/figures/Plot_Inn_Danube_raw_adjusted_v02} 
...
\section{6. Conclusion}\label{conclusion-5}
