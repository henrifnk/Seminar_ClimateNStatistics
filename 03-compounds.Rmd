...
```{r climatemap3-shiyu, cache=FALSE, fig.cap = 'Temperature map in Germany from March to November', out.width='80%', fig.align='center', echo=FALSE, eval = !is_html}
knitr::include_graphics('work/03-compounds/figures/Temperature/Temperature.png')
```

```{r climatemap4-shiyu, cache=FALSE, fig.cap = 'Precipitation map in Germany from March to November', out.width='80%', fig.align='center', echo=FALSE, eval = !is_html}
knitr::include_graphics('work/03-compounds/figures/Precipitation/Precipitation.png')
```
...
```{r climatemap2-shiyu, cache=FALSE, fig.cap = 'Temperature and Precipitation maps in Germany from June to August', out.width='100%', fig.align='center', echo=FALSE, eval = is_html}
...
```{r AveragePrecipitation-shiyu, cache=FALSE, fig.cap = 'Average Precipitation in Germany from March to November and from June to August', out.width='70%', fig.align='center', echo=FALSE, eval = TRUE}
...
```{r TemperatureCPD-shiyu, cache=FALSE, fig.cap = 'Cumulative Probability of Temperature', out.width='65%', fig.align='center', echo=FALSE, eval = TRUE}
...
```{r gmt-shiyu, cache=FALSE, fig.cap = 'Annual Global Mean Temperature Anomalies from March to November and from June to August', out.width='70%', fig.align='center', echo=FALSE, eval = TRUE}
...
data <- data.frame(
  ...
  V2 = c("T", "- P", "Copula", "T", "- P", "Copula", "Utd"),
  EMP = c("-", "-", "Joe(theta = 1.25)", "-", "-", "Joe(theta = 1.31)", "0.3"),
  FIT = c("N(11, 0.7)", "N(-600, 84)", "Survival Clayton(theta = 0.26)", "N(11, 0.76)", "N(-599, 84)", "Joe(theta = 1.21)", "0.22")
)
...
```{r utdmap1-shiyu, cache=FALSE, fig.cap = 'Upper Tail Dependence in different Bundesland from March to November (Original))', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
...
```{r tab4-shiyu, echo=FALSE}
data <- data.frame(
  NO1 = c("Anomalies", "", "", "Anomalies","", "", ""),
  NO2 = c("T", "-P", "Copula", "T", "-P", "Copula", "UTD"),
  EMP = c("-","-", "Survival Clayton (theta = 0.61)", "-", "-", "Joe(theta = 1.53)", 0.43),
  FIT=c("N(0, 0.5)", "N(0, 83)","Survival Clayton(theta = 0.56)","N(0, 0.55)","N(0, 84)","Survival Clayton(theta = 0.58)",0.30))
colnames(data) <- c("", "","EMP","FIT")
...
```{r utdmap2-shiyu, cache=FALSE, fig.cap = 'Upper Tail Dependence in different Bundesland from March to November (Anomalies))', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
...
```{r result2-shiyu, cache=FALSE, fig.cap = 'Rarity of 2018 for Bundesland from March to November', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
...
```{r result5-shiyu, cache=FALSE, fig.cap = 'Rarity of 2018 for Bundesland from June to August', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
knitr::include_graphics('work/03-compounds/figures/RESULTS/resultJJA.png')
```

```{r result6-shiyu, cache=FALSE, fig.cap = 'Rarity of 2018 for Bundesland from June to August (Anomalies)', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
...
```{r prediction2-shiyu, cache=FALSE, fig.cap = 'Prediction for Bundesland from March to November', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
knitr::include_graphics('work/03-compounds/figures/GMT/predictbundeslandMtoN.png')
```

```{r prediction3-shiyu, cache=FALSE, fig.cap = 'Prediction for Bundesland from March to November', out.width='80%', fig.align='center', echo=FALSE, eval = TRUE}
