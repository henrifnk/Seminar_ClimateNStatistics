...
```{r controversial, cache=FALSE, out.width="80%", fig.align="center", echo=FALSE, eval = TRUE}
...
```{r confounder, cache=FALSE, out.width="80%", fig.align="center", echo=FALSE, eval = TRUE}
...
```{r HadISD, cache=FALSE, out.width="80%", fig.align="center", echo=FALSE, eval = TRUE}
